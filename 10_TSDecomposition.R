...
# US retail data shows clear trend and seasonality
...
dcmp <- us_retail_employment %>%
  model(STL(Employed))
components(dcmp)
# parse data to the model function, STL

# Let's compare the trend-cycle component to the full data (red line)
us_retail_employment %>%
